...
For ringdown plus photon geometry, the local Jacobian median $k$/identifiable-
$\wq$ NMAE is 0.0147/0.0259, 0.0184/0.0454, and 0.0661/0.1172 for random,
...
\begin{figure}[tbp]
\centering\includegraphics[width=.82\textwidth]{conditioning_vs_wq_recovery.pdf}
\caption{Spearman association between the change in log minimum singular value
