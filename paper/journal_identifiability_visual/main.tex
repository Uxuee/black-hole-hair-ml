...
Figure~\ref{fig:boundary} records the rank-aware historical benchmark that
motivated the mature physical calculation.

\begin{figure}[t]
\centering\includegraphics[width=.82\linewidth]{learning_when_hair_is_observable_rank_aware.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=.98\linewidth]{shooting/physical_shooting_geometry_overview.pdf}
\caption{Validated physical shooting geometry and representative direct photon
rays. The emitter begins at apocentre at $\phi=\pi$; trajectories were
regenerated from archived converged launch angles without proxy substitution.}
\label{fig:rays}
\end{figure}
