...
Figure~\ref{fig:schwarzschild} shows the arrival-time consistency check.

\begin{figure}[t]
\centering\includegraphics[width=.96\linewidth]{physical_schwarzschild_arrival_validation.png}
...
\begin{figure}[t]
\centering\includegraphics[width=.98\linewidth]{shooting/phase_coloured_photon_shooting_with_inset.pdf}
...
The inset enlarges the stated near-hole coordinate region without changing the
trajectory scale. This is a controlled dimensionless benchmark.}
\label{fig:rays}
\end{figure}
...
\begin{figure*}[t]
\centering\includegraphics[width=.91\textwidth]{shooting/shooting_observables_vs_phase_refined.pdf}
...
initial apocentre and diamonds mark numerical pericentres. All curves use the
...
\begin{figure*}[t]
\centering\includegraphics[width=.93\textwidth]{physical_local_sensitivity_comparison.png}
...
\begin{figure*}[t]
\centering\includegraphics[width=.91\textwidth]{shooting/observer_sky_track_with_residuals.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.96\textwidth]{physical_grid_minimum_singular_value.png}
...
\begin{figure*}[t]
\centering\includegraphics[width=.94\textwidth]{physical_observable_complementarity.png}
...
\begin{table*}[t]
\caption{Primary physical-complementarity summaries. The reported combined-set
gains are the archived grid-wide improvement statistics relative to ringdown,
not ratios formed from separately reported medians.}
\label{tab:complementarity}
\centering
\begin{tabular}{lccc}
Features & $\mathrm{med}(\smin)$ & $\mathrm{med}(\kappaJ)$ & gain \\
\hline
Ringdown & 0.2782 & 6.6112 & reference \\
Ringdown + photon geometry & 1.2326 & 4.0731 & $4.54\times/2.28\times$ \\
...
\begin{figure*}[t]
\centering\includegraphics[width=.95\textwidth]{physical_ml_protocol_comparison.png}
...
The aligned physical and model diagnostics appear in Fig.~\ref{fig:mljac}.

\begin{figure*}[t]
\centering\includegraphics[width=.97\textwidth]{physical_ml_vs_jacobian_complementarity.png}
...
\begin{figure*}[t]
\centering\includegraphics[width=.93\textwidth]{physical_ml_uncertainty_calibration.png}
...
\begin{figure*}[t]
\centering\includegraphics[width=.92\textwidth]{resolution_robustness.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.92\textwidth]{targeted_estimator_robustness.pdf}
...
shift for HGB, RF, and MLP. The annotation records the distinct MLP failure
audit: 410 catastrophic directional records, 409 already catastrophic at 161
phases, and 63 iteration-limit cases. No predictions are clipped.}
\label{fig:estimator-robustness}
\end{figure*}

\begin{table*}[t]
\caption{Targeted 321-phase frozen-estimator robustness.}
\label{tab:robustness}
\centering
\begin{tabular}{lccc}
Model & median & 95th percentile & max. identifiable $\wq$ \\
\hline
...
\begin{figure}[t]
\centering\includegraphics[width=.9\linewidth]{learning_when_hair_is_observable_rank_aware.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.91\textwidth]{shooting/schwarzschild_kiselev_ray_comparison.pdf}
\caption{Matched-phase direct rays for Schwarzschild and $k=10^{-3}$,
