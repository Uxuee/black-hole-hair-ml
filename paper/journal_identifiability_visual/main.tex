...
\begin{figure*}[t]
\centering
\includegraphics[width=.96\textwidth]{historical_analytic_identifiability_lens.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.86\textwidth]{shooting/phase_coloured_photon_shooting_horizontal.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.87\textwidth]{shooting/shooting_observables_vs_phase_refined.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.88\textwidth]{physical_local_sensitivity_comparison.png}
...
\begin{figure*}[t]
\centering\includegraphics[width=.84\textwidth]{shooting/observer_sky_track_with_residuals.pdf}
...
\begin{figure*}[t]
\centering\includegraphics[width=.86\textwidth]{physical_observable_complementarity.png}
...
\begin{figure*}[t]
\centering\includegraphics[width=.82\textwidth]{targeted_estimator_robustness_compact.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=.98\columnwidth]{schwarzschild_arrival_validation_with_residuals.pdf}
