...
\begin{tabular}{lcccc}
\toprule
Features & \multicolumn{2}{c}{Random} & \multicolumn{2}{c}{Grouped}\\
 & $k$ & $\wq$ & $k$ & $\wq$\\
\midrule
Ringdown & .0361 & .1688 & .0485 & .3093\\
Photon geometry & .1088 & .0927 & .1813 & .1111\\
All shooting & .0750 & .0453 & .1241 & .0729\\
Ringdown+photon & .0378 & .0730 & .0457 & .0874\\
Ringdown+all shooting & .0427 & .0454 & .0445 & .0727\\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{physical_ml_protocol_comparison.png}
\caption{Physical-feature inverse error under random interpolation, held-out
contiguous regions, and directional extrapolation.}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{physical_ml_uncertainty_calibration.png}
\caption{Conformal coverage degrades under physical-region and directional
distribution shift.}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{physical_ml_high_resolution_robustness.png}
\caption{Change in inverse-model NMAE when 161-phase features replace their
81-phase counterparts at the 27 validation points.}
